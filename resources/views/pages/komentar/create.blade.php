...
<head>
    ...
    <title>Tambah Data komentar - SantriKoding.com</title>
                    ...
                    <div class="card-body">
                        <form action="{{ route('komentar.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('pesan') is-invalid @enderror" name="pesan" value="{{ old('pesan') }}" placeholder="Masukkan Pesan">
                                @error('pesan')
                                    <div class="alert alert-danger mt-2">
                                        {{ $message }}
                                    </div>
